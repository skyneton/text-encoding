        ...
        return new Promise(async resolve => {
            ...
            for(let i = 0; i < types.length; i++) {
                ...
                if(size == 0) {
                    ...
                    data.min = size;
                    data.before = types[i];
                    data.url = new Blob([result], { type: "text/plain" });
                    break;
                }
